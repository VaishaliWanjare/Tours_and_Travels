...
include("db.php");
	...
	$result=mysqli_query($con,"insert into attendence(student name,roll number)values('$_POST[name]','$_POST[roll]')");
	if($result)
	{
		$flag=1;
	}
...
<div class="panel panel-default">
	...
	<h2>
	<a class="btn btn-success" href="add1.php"> Add student</a>	
